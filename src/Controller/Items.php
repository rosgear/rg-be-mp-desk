...
namespace Rg\Backend\Marketplace\Desk\Controller;
 ...
 * @package Rg\Backend\Marketplace\Desk\Controller
 * @since 1.0
 */
class Items extends BaseController
{
     ...
     * {@inheritdoc}
     * 
     * @var BaseModule|\Rg\Backend\Marketplace\Desk\Extension
     */
    ...
    public function createWidget(): TabWidget
    {
        ...
        // элементы рабочего стола (Ge.view.shortcuts.Shortcuts Gm JS)
        $tab->items = [
